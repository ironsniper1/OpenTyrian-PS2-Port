		...
		do
		{
			...
			if (redraw)
			{
				...
				if (animate)
				{
					...
					#ifdef TARGET_PS2
					ps2_log("title: loadPic 4");
#endif
					JE_loadPic(VGAScreen, 4, false);
#ifdef TARGET_PS2
					ps2_log("title: loadPic 4 done");
#endif
					...
					#ifdef TARGET_PS2
					ps2_log("title: fade_palette");
#endif
					fade_palette(colors, 10, 0, 255 - 16);
#ifdef TARGET_PS2
					ps2_log("title: fade done");
#endif
